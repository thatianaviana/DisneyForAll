...
function FamilyCard(props) {
    return (
        ...
        <div className="card text-white bg-light mb-3">
            <div className="card-header">{props.fullName} </div>
            ...
            <div className="card-body">
                ...
                <button type="button" className="btn btn-outline-info" data-toggle="modal" data-target="#exampleModalLong" onClick={() => props.handleClick(props.fullName, props.aboutFamily)}>
                    Meet the Family
            </button>
            </div>
        </div>
